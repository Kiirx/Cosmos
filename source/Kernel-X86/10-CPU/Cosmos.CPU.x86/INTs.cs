...
public class INTs
{
    ...
    public static void HandleInterrupt_02(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Non Maskable Interrupt Exception", "Non Maskable Interrupt Exception", ref aContext);
    ...
    public static void HandleInterrupt_04(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Into Detected Overflow Exception", "Into Detected Overflow Exception", ref aContext);
    ...
    public static void HandleInterrupt_09(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Coprocessor Segment Overrun Exception", "Coprocessor Segment Overrun Exception", ref aContext);
    ...
    public static void HandleInterrupt_13(ref IRQContext aContext) => HandleException(aContext.EIP,
        "SIMD Floating Point Exception", "SIMD Floating Point Exception", ref aContext);
